...
```{r, cache=FALSE}
name = paste("../figs/knit/ev-finaldata-histo", gsub("/", "", dataloc), ".pdf", sep = "")
...
p1 <- my_gg_plot_no_legend(data, var = "likBB_median", xlab = "Four Option Deviance", color_choose = "age",
						   # limits_choose = c(0, 200), breaks_choose = c(50, 100, 150), labels_choose = expression(50, 100, 150), normaldens)
